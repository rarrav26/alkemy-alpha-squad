...
{
    /// <inheritdoc />
    public partial class AddIdentityAndUserRegistration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cvu = table.Column<string>(type: "varchar(22)", unicode: false, maxLength: 22, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "seeded-role-usuario", "Usuario", "USUARIO" });
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_Accounts_Alias",
                table: "Accounts",
                column: "Alias",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ_Accounts_Cvu",
                table: "Accounts",
                column: "Cvu",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_User_DocumentType_Number",
                table: "AspNetUsers",
